...
def init_db(app, testing=False):
    ...
    with app.app_context():
        ...
        account_type_7 = api.account_type_create("savings", 3300)
        account_type_8 = api.account_type_create("money to burn", 3500)
        account_type_9 = api.account_type_create("rainy day", 3700)
        ##
        if testing is True:
            ##
